...
public class TableCart extends JPanel{
	...
	private String[] columns = { "Mã hóa đơn", "Mã sản phẩm", "Số lượng","Đơn giá"};
...
//	}
	...
	public void updateTable(List<MuaHang> list){
		...
		for(int i=0;i<list.size();i++){
			...
			data[i][0] = s.getIdHoaDon();
			data[i][1] = s.getIdSanPham();
			data[i][2] = String.valueOf(s.getSoLuong());
			data[i][3] = format.format(s.getDonGia());
		}
